...
description: Run independent subtasks concurrently and aggregate results deterministically.
license: MIT
---

# parallelization

Run independent subtasks concurrently and aggregate results deterministically.
