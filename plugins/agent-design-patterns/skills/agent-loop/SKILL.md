---
name: agent-loop
description: Use a bounded plan-act-observe-adjust loop when dynamic tool selection is required.
license: MIT
---

# agent-loop

Use a bounded plan-act-observe-adjust loop when dynamic tool selection is required.
